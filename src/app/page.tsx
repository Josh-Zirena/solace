        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-20">
            ...
            <div className="flex items-center justify-center space-x-3">
              ...
              <p className="text-solace-primary font-medium text-lg">Finding your perfect healthcare advocate...</p>
            </div>
          </div>
        </div>
      </main>
    ...
    <main className="min-h-screen bg-gradient-to-br from-solace-accent via-solace-secondary to-solace-mint/20 p-6 font-lato">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-solace-primary text-xl font-medium mb-6">Find experienced healthcare advocates in your area</p>
        </div>
          ...
          <div className="relative z-10">
            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
              <div className="flex-1">
                <label htmlFor="search" className="block text-lg font-bold text-solace-primary mb-3">
                  Search Advocates
                </label>
                <input
                  id="search"
            ...
            {searchTerm && (
              <div className="mt-4 p-4 bg-gradient-to-r from-solace-emerald/10 to-solace-mint/10 rounded-2xl border border-solace-mint/30">
                <div className="text-lg text-solace-primary font-medium">
                  Showing results for: <span className="font-bold text-solace-emerald">{searchTerm}</span>
                </div>
              </div>
            )}
          </div>
          ...
          <table className="min-w-full">
            ...
            <tbody className="divide-y divide-solace-mint/20">
              {filteredAdvocates.map((advocate, index) => (
                <tr key={advocate.phoneNumber} className={`hover:bg-gradient-to-r hover:from-solace-mint/10 hover:to-solace-sage/10 transition-all duration-200 transform hover:scale-[1.01] ${
                  ...
                  <td className="px-6 py-6 whitespace-nowrap">
                    <div className="text-base text-solace-gray-dark font-medium">{advocate.city}</div>
                  </td>
                  <td className="px-6 py-6 whitespace-nowrap">
                    <div className="text-base text-solace-gray-dark font-medium">{advocate.degree}</div>
                  </td>
                      ...
                      {advocate.specialties.map((specialty, idx) => {
                        ...
                        return (
                          <span
                            ...
                            className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium shadow-sm transform hover:scale-105 transition-all duration-200 ${colors[idx % colors.length]}`}
                          >
                            {specialty}
                          </span>
                        );
                  ...
                  <td className="px-6 py-6 whitespace-nowrap">
                    <div className="text-base text-solace-gray-dark font-bold">{advocate.yearsOfExperience} years</div>
                  </td>
                  <td className="px-6 py-6 whitespace-nowrap">
                    <a
        ...
        <div className="lg:hidden space-y-6">
          {filteredAdvocates.map((advocate) => (
            <div key={advocate.phoneNumber} className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl border-2 border-solace-mint/30 p-6 transform hover:scale-105 transition-all duration-300 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-lg text-solace-gray-dark font-medium">{advocate.city}</p>
                  </div>
                  <a
                    href={`tel:${advocate.phoneNumber}`}
                ...
                <div className="space-y-4">
                  <div className="bg-gradient-to-r from-solace-secondary/50 to-solace-mint/20 rounded-2xl p-4">
                    <dt className="text-sm font-bold text-solace-primary mb-1">Credentials</dt>
                    <dd className="text-base text-solace-gray-dark font-medium">{advocate.degree}</dd>
                  </div>
                  
                  <div className="bg-gradient-to-r from-solace-mint/20 to-solace-sage/20 rounded-2xl p-4">
                    <dt className="text-sm font-bold text-solace-primary mb-1">Experience</dt>
                    <dd className="text-base text-solace-gray-dark font-medium">{advocate.yearsOfExperience} years</dd>
                  </div>
                  
                  <div className="bg-gradient-to-r from-solace-sage/20 to-solace-emerald/20 rounded-2xl p-4">
                    <dt className="text-sm font-bold text-solace-primary mb-2">Specialties</dt>
        ...
        {filteredAdvocates.length === 0 && (
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl border-2 border-solace-mint/30 p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <svg className="mx-auto h-16 w-16 text-solace-primary/40 mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              <h3 className="text-3xl font-bold text-solace-primary mb-4">No advocates found!</h3>
              <p className="text-xl text-solace-gray-dark mb-6">Try adjusting your search criteria or clearing the search to see all advocates.</p>
